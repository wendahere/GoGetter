...
#for x in range(0, 57):
#    pixels.setPixelColor(x, Color(255,255,255))
#pixels.show()
...
#GND setup
gpio.setup(40, gpio.OUT) #Column 1
...
def LEDClear(pixels):
    ...
    for j in range(pixels.numPixels()):
        pixels.setPixelColor(j, Color(0, 0, 0))
        pixels.show()

def tier1LED():
    for k in range(0, 19):
        pixels.setPixelColor(k, Color(255,0,0))
    pixels.show()


def tier2LED():
    for l in range(0, 19):
        pixels.setPixelColor(l, Color(255,0,0))

    for m in range(19, 38):
        pixels.setPixelColor(m, Color(0,128,255))
    pixels.show()

def tier3LED(pixels):
    print("meow")
    for i in range(pixels.numPixels()):
        pixels.setPixelColor(i, Color(255, 0, 0))
        pixels.show()
    #for x in range(0, 19):
     #   pixels.setPixelColor(x, Color(255,0,0))
      #  pixels.show()

  #  for x in range(19, 38):
  #      pixels.setPixelColor(x, Color(0,128,255))
  #      pixels.show()

   # for x in range(38, 57):
    #    pixels.setPixelColor(x, Color(255,255,0))
    #    pixels.show()
